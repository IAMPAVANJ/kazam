...
export default function ProfilePopup({isOpen, setIsOpen}:{isOpen:boolean, setIsOpen: (isOpen: boolean) => void}) {
          ...
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            >
              ...
              <div className="flex flex-col items-start justify-center mt-2">
                ...
                <p className="mt-2 text-sm/6 text-gray/50">{user.email}</p>
              </div>
              <div className="mt-4">
                <Button
